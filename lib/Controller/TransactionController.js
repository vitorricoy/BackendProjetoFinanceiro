...
router.put('/', function(req, res) {
    _transactionService.getTransactions(req.body.user_id, req.body.month, req.body.transaction_id, req.body.new_transaction)
        .then((success) => {
            res.send(success);
        })
        .catch((err) => {
...
router.delete('/', function(req, res) {
    _transactionService.getTransactions(req.query.transaction_id)
        .then((success) => {
            res.send(success);
        })
        .catch((err) => {
